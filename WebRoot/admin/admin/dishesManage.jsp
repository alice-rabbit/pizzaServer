...
function userSearch(){
	$('#dg').datagrid('load',{
		s_c_user: $("#s_c_user").val(),      
		s_s_user: $("#s_s_user").val(), 
	});
}
//删除的javascript方法
...
function userAddDialog(){
	$("#dlg").dialog("open").dialog("setTitle","添加配对");
	url="../../fangwu?op=add";
}
//修改按钮事件，打开修改数据对话框
function userUpdateDialog(){
	...
	$("#dlg").dialog("open").dialog("setTitle","商品信息修改");
	$("#form").form("load",row);
	  ...
	  pagination="true" rownumbers="true" url="../../fangwu?op=list" toolbar="#tb" fit="true">
		<thead>
			<tr>
				...
				<th align="center" field="id" width="10">商品ID</th>
				<th align="center" field="classify"      width="10">商品分类</th>
				<th align="center" field="name"  width="10">商品名字</th>
				<th align="center" field="describe"  width="30">描述</th>
				<th align="center" field="price"  width="10">价格</th>
				<th align="center" field="receive_id"  width="10">买家ID</th>
				<th align="center" field="status"  width="10">商品状态</th>
			</tr>
		</thead>
	</table>
	<!-- 工具条，基本操作 -->
	<div id="tb" style="padding-top: 10px;padding-bottom: 10px;padding-left: 10px">
		<div title="您的位置">您的位置：导航菜单>>查看商品</div><hr>
		...
		<div style="color: black"></div>
		 <div title="">
	       ...
	       <a title="修改" href="javascript:userUpdateDialog()" class="easyui-linkbutton" iconCls="icon-edit" plain="">修改</a> 
			...
			<form action="${pageContext.request.contextPath}/servlet/UpDwonServlet?&op=UpLoad" method="post" enctype="multipart/form-data">
                                商品名称：<input type="text" name="name">                  
                                商品描述：<input type="text" name="describe">                  
                                商品价格：<input type="text" name="price"><br>                  
                                上传资源：<input type="file" name="upload1">
           &nbsp;商品类型：&nbsp;
			<select  id="classify" name="classify">
  		   <option value="0" >比萨</option>
           <option value="1" >主菜</option>
           <option value="2">小食</option>
		...
		<div title="查询条件" style="padding-top: 5px">
			...
			<!-- &nbsp;卖家ID：&nbsp;<input type="text" name="s_c_user" id="s_c_user" size=15 />&nbsp; -->
			&nbsp;买家ID：&nbsp;<input type="text" name="s_s_user" id="s_s_user" size=10 />&nbsp;
	...
	<div id="dlg" class="easyui-dialog" style="width: 450px;height: 400px" buttons="#dlg-button" title="操作对话框" closed="true">
		<form method="post" id="form" name="form">
			<table align="center" style="margin-top: 48px">
				...
				<tr>
					<td>商品名称：</td>
					<td><input type="text" name="name" id="name" class="easyui-validatebox" size=20 required="true"/></td>
					<td><font color="red">***此项为必填项***</font></td>
				</tr>
				<tr height="5px"></tr>
				<tr>
					<td> 商品描述：</td>
					<td><input type="text" name="describe" id="describe" class="easyui-validatebox" size="20" required="true"/></td>
					<td><font color="red">***此项为必填项***</font></td>
				</tr>
				<tr height="5px"></tr>
				...
				<tr>
					<td> 商品价格：</td>
					<td><input type="text" name="price" id="price" class="easyui-validatebox" size=20 required="true"/></td>
					<td><font color="red">***此项为必填项***</font></td>
				</tr>
